...
function Stats() {
  const stats = [
    { value: 120, suffix: "+", label: "Commerçants actifs" },
    { value: 100, suffix: "K+", label: "Transactions traitées" },
    { value: 15, suffix: "+", label: "Villes au Cameroun" },
...
const testimonials = [
  {
    name: "Ngassa Paul-Éric",
    role: "Directeur, MegaShop",
    location: "Yaoundé",
  ...
  {
    name: "Mbouda Sandrine",
    role: "Propriétaire, Cosmétiques Sandy",
    location: "Douala",
  ...
  {
    name: "Talla Christophe",
    role: "Co-fondateur, Talla & Frères",
    location: "Bamenda",
  ...
  {
    name: "Nguemé Cécile",
    role: "Gérante, Superette du Coin",
    location: "Bertoua",
    text: "Depuis que j'utilise Kioské, mes employés sont plus autonomes. Chacun a ses permissions et je vois tout ce qui se passe dans ma boutique depuis mon téléphone. Un vrai soulagement.",
    rating: 5,
  },
  {
    name: "Kamga Olivier",
    role: "Propriétaire, Quincaillerie Kamga",
    location: "Bafoussam",
    text: "J'ai essayé plusieurs logiciels de gestion avant Kioské. Aucun n'était aussi simple et aussi complet. L'équipe de support répond en moins d'une heure, c'est exceptionnel.",
    rating: 5,
  },
  {
    name: "Atangana Béatrice",
    role: "Fondatrice, Bio Naturel",
    location: "Yaoundé",
    text: "Le système de fidélité intégré a changé la donne. Mes clientes reviennent plus souvent et dépensent plus. En 6 mois, mon chiffre d'affaires a augmenté de 25%.",
    rating: 5,
  },
  {
    name: "Njoya Ibrahim",
    role: "Gérant, Librairie Savoir",
    location: "Garoua",
    text: "Gérer des milliers de références de livres n'est pas simple. Avec Kioské, le scan des codes-barres et la mise à jour automatique du stock me font gagner un temps fou chaque jour.",
    rating: 4,
  },
];
